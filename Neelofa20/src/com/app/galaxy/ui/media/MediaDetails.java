...
public class MediaDetails extends Fragment{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		// TODO Auto-generated method stub
		View v = LayoutInflater.from(getActivity()).inflate(R.layout.mediadetails,
				null);
	...
	public class NewsDetailsDownload extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... params) {
			...
			try {
				...
				System.out.println(commentsResp+comments.size());
		...
		public void loadUi() {
			...
			try {
				...
				startStreamingAudio(v,URLS.TEMP_ITEMS_IMG_URL+URLS.TEMP_URL_URL+details.src+"."+details.type);
				...
				System.out.println("LAxmikant"+comments.size());;
	...
	private void startStreamingAudio(View v,String medid) {
    	try { 
